...
# ── Core bot config ────────────────────────────────────────────────────────────
API_ID = int(getenv("API_ID", 34947583))
API_HASH = getenv("API_HASH", "a02704b38ef4aca294dec32b3dce573c")
BOT_TOKEN = getenv("BOT_TOKEN")

OWNER_ID = int(getenv("OWNER_ID", 7660990923))
OWNER_USERNAME = getenv("OWNER_USERNAME", "Lord_Vasudev_Krishna")
BOT_USERNAME = getenv("BOT_USERNAME", "Max_music_xbot")
BOT_NAME = getenv("BOT_NAME", "˹𝐌ᴀx 𝐌ᴀʏғɪᴇʟᴅ ✘ 𝙼ᴜsɪᴄ 𝙱ᴏᴛ˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "˹𝐌ᴀx 𝐌ᴀʏғɪᴇʟᴅ ✘ 𝙰ssɪsᴛᴀɴᴛ˼ ♪")

# ── Database & logging ─────────────────────────────────────────────────────────
MONGO_DB_URI = getenv("MONGO_DB_URI")
LOGGER_ID = int(getenv("LOGGER_ID", -1003334379453))
...
# ── Git / updates ──────────────────────────────────────────────────────────────
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/itskrishname/max-music-bots")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "feature/collapsible-quotes-logger-update-10475438261086399022")
GIT_TOKEN = getenv("GIT_TOKEN")  # needed if repo is private

# ── Support links ──────────────────────────────────────────────────────────────
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SECRECT_BOT_UPDATES")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/SECRECT_BOT_UPDATES")
...
# ── Media assets ───────────────────────────────────────────────────────────────
START_VIDS = [
    "https://files.catbox.moe/z3n59s.jpg",
    "https://files.catbox.moe/w7ebuy.jpg",
    "https://files.catbox.moe/3fsyfk.jpg",
]
STICKERS = [
...
TELEGRAM_VIDEO_URL = "https://files.catbox.moe/685f2g.jpg"
STREAM_IMG_URL = "https://files.catbox.moe/6nbb55.jpg"
SOUNCLOUD_IMG_URL = "https://files.catbox.moe/6nbb55.jpg"
YOUTUBE_IMG_URL = "https://files.catbox.moe/y9yox7.jpg"
...
AYU = [
    ...
    "<blockquote expandable>🔍</blockquote>",
    "<blockquote expandable>🧪</blockquote>",
    "<blockquote expandable>⚡️</blockquote>",
    "<blockquote expandable>🔥</blockquote>",
    "<blockquote expandable>🎩</blockquote>",
    "<blockquote expandable>🌈</blockquote>",
    "<blockquote expandable>🍷</blockquote>",
